...
#                   ['/person_plan', '/remind']]
reply_keyboard1 = [[InlineKeyboardButton("wrong", callback_data="wrong"),
                    InlineKeyboardButton("Готовый план", callback_data="ready_plan"),],
...
# async def wrong(update, context):
#     await update.message.reply_text('УЛЮЛЮ, уходи тогда', reply_markup=time_for_r)

async def wrong(update, context):
    callback_query = update.callback_query
    await callback_query.answer()
    await callback_query.message.reply_text("УЛЮЛЮ, уходи тогда", reply_markup=time_for_r)
